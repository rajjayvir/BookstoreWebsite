...
# Activity / Lab / Assignment / Project Title: Lab 1

**[Optional]** If what is being submitted is an individual Lab or Assignment. Otherwise, include a brief one paragraph description about the project.

* *Date Created*: 17 Sep 2021
* *Last Modification Date*: 17 Sep 2021
* *Lab URL*: https://web.cs.dal.ca/~jraj/csci2170/lab1/index.php
* *Git URL*: https://git.cs.dal.ca/jraj/csci-2170/-/tree/main/labs

## Authors

* [Jayvirsinh Pradipsinh Raj](jayvir@dal.ca) 
...
Had used some of the functions from W3Schools to get a better code clarity and also took help of lectures via Brightspace from csci 2170. 